...
class PreActBottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, scale=1.0):
        ...
        self.scaler2 = Scaler(scale)
        self.bn3 = nn.BatchNorm2d(planes, momentum=None, track_running_stats=False)
...
class PreActResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, input_channels=3, p: float = 1.0):
        ...
        self.final_bn = nn.BatchNorm2d(self.in_planes, momentum=None, track_running_stats=False)
...
@MODEL_REGISTRY.register("hetero_PreResNet18")
def HeteroPreResNet18(num_classes=10, input_channels=3, p: float = 1.0):
    return PreActResNet(PreActBlock, [2, 2, 2, 2], num_classes=num_classes, input_channels=input_channels, p=p)
